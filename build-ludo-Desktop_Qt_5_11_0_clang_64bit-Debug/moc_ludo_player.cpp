...
void ludo_player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ludo_player::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ludo_player::select_piece)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ludo_player::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ludo_player::turn_complete)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ludo_player::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ludo_player.data,
      qt_meta_data_ludo_player,  qt_static_metacall, nullptr, nullptr}
};
